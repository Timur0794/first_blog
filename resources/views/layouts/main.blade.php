        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        @guest()
                            <a class="nav-link" href="{{route('user.main.index')}}">Войти <span class="sr-only">(current)</span></a>
                        @endguest
                        @auth()
                            <a class="nav-link" href="{{route('user.main.index')}}">Личный Кабинет <span class="sr-only">(current)</span></a>
